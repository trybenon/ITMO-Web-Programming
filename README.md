...
В данном репозитории представлены исходные коды **4-х лабораторных работ** по курсу "Веб-программирование", направленных на практическое освоение современных веб-технологий (от базового HTTP и сервлетов до современных SPA-фреймворков и Enterprise-решений). Каждая работа лежит в свобственной ветке репозитория.
